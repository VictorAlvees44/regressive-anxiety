...
registerRoute(
  /^https:\/\/(images\.unsplash\.com|image\.tmdb\.org|images\.igdb\.com|images\.gog-statics\.com|cdn\.cloudflare\.steamstatic\.com|shared\.akamai\.steamstatic\.com|cdn\d1\.epicgames\.com|cdn1\.epicgames\.com|media\.rawg\.io)\/.*/,
  new CacheFirst({
